 ...
 * 05-Nov-2008<br><br>
 */
public class DomainLemmaGenerator<E> extends LemmaGenerator<E> {


    public DomainLemmaGenerator(Explanation<E> explanation, ExplanationGeneratorFactory<E> explanationGeneratorFactory,  OWLReasonerFactory reasonerFactory, OWLDataFactory dataFactory) {
