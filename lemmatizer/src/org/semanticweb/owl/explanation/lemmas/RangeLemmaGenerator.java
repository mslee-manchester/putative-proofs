 ...
 * 06-Nov-2008<br><br>
 */
public class RangeLemmaGenerator<E> extends LemmaGenerator<E> {


    public RangeLemmaGenerator(Explanation<E> explanation, ExplanationGeneratorFactory<E> explanationGeneratorFactory, OWLReasonerFactory reasonerFactory, OWLDataFactory dataFactory) {
